...
\includegraphics[width=0.35\textwidth]{logo_atm.png}
	...
	\begin{table}[H]
		...
		\begin{tabular}{|p{4cm}|p{10cm}|}
			...
			\hline
			Academia Tehnică Militară & Conducerea instituției care va evalua proiectul \\
			\hline
			Profesor Coordonator & Evaluare și îndrumare tehnică \\
			\hline
			Comisia de Licență & Evaluarea finală a proiectului \\
			\hline
		\end{tabular}
	\end{table}
...
Această secțiune detaliază cerințele funcționale ale platformei software de unelte AI în criptografie, organizate pe module majore.
	...
	\begin{longtable}{|p{2cm}|p{12cm}|}
		...
		\hline
		NFR-PRF-007 & Sistemul \reqshall să suporte minim 100 de cereri concurente. \\
		\hline
		NFR-PRF-008 & Sistemul \reqshould să suporte minim 500 de utilizatori concurenți activi. \\
		\hline
	...
	\subsection{Licensing și Open Source}

	\subsubsection{Complianță Licențe}
	...
	\begin{longtable}{|p{2cm}|p{12cm}|}
		...
		CMP-LIC-001 & Proiectul \reqshall să fie licențiat sub MIT License. \\
		\hline
		CMP-LIC-002 & Sistemul \reqshall să documenteze toate dependențele și licențele lor. \\
		\hline
		CMP-LIC-003 & Sistemul NU \reqshall să includă dependențe cu licențe incompatibile. \\
		\hline
	\end{longtable}
	...
	\newpage
	\section{Anexă}
Această anexă conține diagramele UML care ilustrează arhitectura și funcționalitățile platformei software de unelte AI în criptografie.
	...
	\begin{figure}[H]
		\centering
		\includesvg[width=0.9\textwidth,height=0.75\textheight,keepaspectratio]{diagrama_use_case_anonymous}
	...
	\begin{figure}[H]
		\centering
		\includesvg[width=0.9\textwidth,height=0.75\textheight,keepaspectratio]{diagrama_use_case_user}
	...
	\begin{figure}[H]
		\centering
		\includesvg[width=0.9\textwidth,height=0.75\textheight,keepaspectratio]{diagrama_use_case_admin}
	...
	\begin{figure}[H]
		\centering
		\includesvg[width=0.9\textwidth,height=0.75\textheight,keepaspectratio]{diagrama_use_case_external_system}
	...
	\subsection{Arhitectura pe Niveluri}

Arhitectura platformei software de unelte AI în criptografie este organizată pe 5 niveluri verticale:
	...
	\begin{enumerate}
		...
		\item \textbf{Nivel Agenți} - 6 agenți specializați (Password, Prime, Theory, Command, Choice, Cryptosystem)

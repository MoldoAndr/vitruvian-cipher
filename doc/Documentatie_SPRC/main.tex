...
\begin{figure}[h]
    \centering
    \includegraphics[width=1.00\textwidth]{images/diagarama_theory_specialist.pdf}
    \caption{Diagrama arhitectură Sistem RAG pentru asistență teoretică}
\end{figure}
\newpage
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.95\textwidth]{images/diagarama_password_checker.pdf}
    \caption{Diagrama arhitectură modul verificare parole}
\end{figure}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.6\textwidth]{images/diagarama_choice_maker_make_choice.pdf}
    \caption{Diagrama componentă make\_choice pentru detectarea intenției și entităților}
\end{figure}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.38\textwidth]{images/diagarama_choice_maker_generate_questions.pdf}
    \caption{Diagrama componentă generate\_questions pentru generarea corpusului TOON}
\end{figure}
